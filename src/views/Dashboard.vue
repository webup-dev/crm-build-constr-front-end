    ...
    <b-row>
      <b-col sm="6" lg="3">
        <b-card no-body class="bg-primary">
          ...
          <card-line1-chart-example chartId="card-chart-01" class="chart-wrapper px-3" style="height:70px;"
                                    :height="70"/>
        </b-card>
      </b-col>
      <b-col sm="6" lg="3">
        <b-card no-body class="bg-info">
          ...
          <card-line2-chart-example chartId="card-chart-02" class="chart-wrapper px-3" style="height:70px;"
                                    :height="70"/>
        </b-card>
      </b-col>
      <b-col sm="6" lg="3">
      ...
      <b-col md="12">
        <b-card header="Traffic &amp; Sales">
            ...
            <b-col sm="12" lg="6">
              <b-row>
                <b-col sm="6">
                  <Callout variant="info">
                    ...
                    <div class="chart-wrapper" :style="{ top: '-10px'}">
                      ...
                      <callout-chart-example chartId="callout-chart-01" :data="[35, 23, 56, 22, 97, 23, 64]"
                ...
                <b-col sm="6">
                  <Callout variant="danger">
                    ...
                    <div class="chart-wrapper" :style="{ top: '-10px'}">
                      <callout-chart-example chartId="callout-chart-02" :data="[65, 59, 84, 84, 51, 55, 40]"
              ...
              <div class="progress-group mb-4">
                ...
                <div class="progress-group-bars">
                  <b-progress variant="info" :value="34" height={} class="progress-xs"/>
                  <b-progress variant="danger" :value="78" height={} class="progress-xs"/>
                </div>
              </div>
              <div class="progress-group mb-4">
                <div class="progress-group-prepend">
              ...
              <b-row>
                <b-col sm="6">
                  <Callout variant="warning">
                    ...
                    <div class="chart-wrapper" :style="{ top: '-10px'}">
                      <callout-chart-example chartId="callout-chart-03" :data="[35, 23, 56, 22, 97, 23, 64]"
                ...
                <b-col sm="6">
                  <Callout variant="success">
                    ...
                    <div class="chart-wrapper" :style="{ top: '-10px'}">
                      <callout-chart-example chartId="callout-chart-04" :data="[65, 59, 84, 84, 51, 55, 40]"
          ...
          <b-table class="mb-0 table-outline" responsive="sm" hover :items="tableItems" :fields="tableFields"
            ...
            <i slot="country" class="h4 mb-0" :class="flag(item.value.flag)" slot-scope="item" :title="item.value.flag"
               :id="item.value.flag"></i>
